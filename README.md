...
-  🛠 I'm proficient with Spark, Hadoop, Kafka, Airflow, Azure Cloud, AWS, Docker, Data Warehouse, Data Lake, Azure Machine Learning, Azure DevOps, Python, SQL, Azure Data Factory (ADF), Extract Transform Load (ETL), Mongodb (NoSQL), Postgres, Git, Microsoft Fabric, Power BI and Microsoft Excel with formulas.
